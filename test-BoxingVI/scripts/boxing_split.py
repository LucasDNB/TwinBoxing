...
# Videos reservados para validacion. Ver docstring punto 3.
...
def main():
    ...
    # --- 1. Filtrado por largo plausible ---
    ...
    # --- 3. Chequeos de sanidad del split ---
    print("\n### CHEQUEOS ###")
    ...
    # --- 4. Distribucion por clase y pesos ---
    ...
    for c in classes:
        ...
        w = n_tr / (k * a) if a else 0.0        # frecuencia inversa balanceada
        weights[c] = round(w, 4)
